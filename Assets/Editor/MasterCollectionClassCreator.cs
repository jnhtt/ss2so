...
public static class MasterCollectionClassCreator
{
    ...
    public static bool Create(string masterName, string jsonString)
    {
        try {
            ...
            CreateMasterCollectionClassScript(masterName, masterJsonData);
    ...
    private static void CreateMasterCollectionClassScript(string masterName, LitJson.JsonData masterJsonData)
    {
        string classContent =
...
{
    [Serializable]
    public partial class $0Collection : MasterCollection<$1, $2>
    {
        $3
    }
}
